...
export default function App() {
  ...
  const Navbar = () => (
    <nav style={{
      background: page === 'landing' ? 'rgba(245,243,238,0.95)' : '#0C1B33',
      borderBottom: page === 'landing' ? '1px solid rgba(184,176,160,0.4)' : '1px solid #1E3A5F',
      backdropFilter: 'blur(12px)',
    }} className="sticky top-0 z-50">
      {/* Gold rule at very top */}
      <div style={{ height: page === 'landing' ? 1 : 2, background: 'linear-gradient(90deg, #B8960C, #D4AF37, #B8960C)', opacity: page === 'landing' ? 0.4 : 1 }} />
      <div className="max-w-5xl mx-auto px-6 lg:px-10">
        <div className="flex justify-between items-center" style={{ height: 60 }}>
          ...
          <button onClick={() => navigate('landing')} className="flex items-center gap-3 group">
            <Scale style={{ width: 20, height: 20, color: page === 'landing' ? '#B8960C' : '#D4AF37' }} />
            <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 18, fontWeight: 600, color: page === 'landing' ? '#0C1B33' : 'white', letterSpacing: '-0.01em' }}>
              Legal Sahara
            </span>
          ...
          <div className="hidden md:flex items-center gap-8">
            <button onClick={() => navigate('landing')} style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: '0.15em', textTransform: 'uppercase', color: page === 'landing' ? '#6B6B6B' : '#9CA8BC' }}
                    className="hover:text-stone-900 transition-colors">Platform</button>
            <button onClick={() => navigate('pricing')} style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: '0.15em', textTransform: 'uppercase', color: page === 'landing' ? '#6B6B6B' : '#9CA8BC' }}
                    className="hover:text-stone-900 transition-colors">Retainers</button>
            ...
            {isLoggedIn ? (
              ...
              <div className="flex items-center gap-4">
                <button onClick={() => navigate('login')} style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: '0.15em', textTransform: 'uppercase', color: page === 'landing' ? '#6B6B6B' : '#9CA8BC' }}
                        className="hover:text-stone-900 transition-colors">Login</button>
                <button onClick={() => navigate('signup')}
                        style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: '0.15em', textTransform: 'uppercase', background: '#0C1B33', color: 'white', padding: '8px 18px', fontWeight: 500 }}
  ...
  const LandingPage = () => (
    <div style={{ background: '#F5F3EE', overflow: 'hidden' }}>
      <style>{`
        ...
        .hero-line-1 { animation: fadeUp 0.7s ease 0.1s both; }
        .hero-line-2 { animation: fadeUp 0.7s ease 0.25s both; }
        .hero-line-3 { animation: fadeUp 0.7s ease 0.4s both; }
        .hero-line-4 { animation: fadeUp 0.7s ease 0.55s both; }
        .hero-line-5 { animation: fadeUp 0.7s ease 0.7s both; }
        .stat-item { animation: fadeUp 0.6s ease both; }
        .cap-row:hover .cap-icon-wrap { background: #0C1B33; }
        .cap-row:hover .cap-icon-wrap svg { color: #D4AF37 !important; }
      `}</style>

      {/* ── HERO ── */}
      <div style={{
        background: 'linear-gradient(175deg, #FAF8F4 0%, #F0EDE5 55%, #EAE4D8 100%)',
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-10" style={{ textAlign: 'center', position: 'relative' }}>
          <div className="hero-line-1" style={{
            fontFamily: "'DM Mono', monospace", fontSize: 9, letterSpacing: '0.22em',
            textTransform: 'uppercase', color: '#B8960C', marginBottom: 28,
            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12,
          }}>
            <span style={{ display: 'inline-block', width: 28, height: 1, background: '#B8960C', opacity: 0.6 }} />
          ...
          <h1 className="hero-line-2" style={{
            ...
            fontWeight: 700, lineHeight: 1.08, color: '#0C1B33',
          ...
          <p className="hero-line-4" style={{
            fontFamily: "'EB Garamond', Georgia, serif",
            fontSize: 20, lineHeight: 1.8, color: '#4A4035',
            maxWidth: 620, margin: '0 auto 48px', fontWeight: 400,
          }}>
            Empowering High Court and Supreme Court advocates with agentic AI. Research PLD and SCMR precedents, brief voluminous case files, and draft court-ready petitions.
          </p>

          <div className="hero-line-5" style={{ display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'center' }}>
            <button onClick={() => navigate('signup')}
              style={{
                background: '#0C1B33', color: 'white',
                fontFamily: "'DM Mono', monospace", fontSize: 10,
                letterSpacing: '0.15em', textTransform: 'uppercase',
                padding: '15px 32px', display: 'flex', alignItems: 'center', gap: 10,
            ...
            <button onClick={() => navigate('pricing')}
              style={{
                background: 'transparent', color: '#0C1B33',
                fontFamily: "'DM Mono', monospace", fontSize: 10,
                letterSpacing: '0.15em', textTransform: 'uppercase',
                padding: '15px 32px', border: '1px solid rgba(12,27,51,0.35)',
                cursor: 'pointer', transition: 'border-color 0.15s',
              }}
              onMouseOver={e => e.currentTarget.style.borderColor = '#0C1B33'}
              onMouseOut={e => e.currentTarget.style.borderColor = 'rgba(12,27,51,0.35)'}>
              View Retainers
            </button>
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)' }}>
            {[
              ...
              <div key={i} className="stat-item" style={{
                ...
                <div style={{
                  fontFamily: "'Playfair Display', Georgia, serif",
                  fontSize: 30, fontWeight: 700, color: 'white', marginBottom: 6,
                }}>{s.n}</div>
                <div style={{
                  fontFamily: "'DM Mono', monospace", fontSize: 9,
                  letterSpacing: '0.14em', textTransform: 'uppercase', color: '#4A5E7A',
                }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
        <div style={{ height: 1, background: 'linear-gradient(90deg, transparent, #1E3A5F, transparent)' }} />
      </div>

      {/* ── CAPABILITIES — flowing rows ── */}
      <div style={{
        background: 'linear-gradient(180deg, #EDEAE2 0%, #F5F3EE 100%)',
        padding: '96px 0 80px',
      }}>
        <div className="max-w-5xl mx-auto px-6 lg:px-10">
          <div style={{ marginBottom: 72, textAlign: 'center' }}>
            <div style={{
              ...
              color: '#B8960C', marginBottom: 16,
            }}>Core Capabilities</div>
            <h2 style={{
              fontFamily: "'Playfair Display', Georgia, serif",
              fontSize: 40, fontWeight: 700, color: '#0C1B33', lineHeight: 1.15,
            }}>Engineered for the Bar</h2>
          </div>
            ...
            {[
              {
                ...
                subtitle: 'Hybrid Retrieval Engine',
                desc: 'Semantic and BM25 search across 10,000 indexed judgments. Retrieve ratio decidendi with verified citation authority — PLD, SCMR, YLR ranked by binding force.',
                align: 'left',
              },
              {
                icon: FileCheck2,
                title: 'Case File Briefing',
                subtitle: 'OCR-Enabled Analysis',
              ...
              },
              {
                ...
                subtitle: 'LangGraph Pipeline + PDF',
                desc: 'Classifies your matter, detects red flags, retrieves precedents, and formats all five petition types. Exports a court-ready PDF with professional typesetting.',
                align: 'left',
              },
            ].map(({ icon: Icon, title, subtitle, desc, align }, i) => (
              <div key={i} className="cap-row" style={{
                ...
                gap: 64,
                padding: '52px 0',
                borderBottom: i < 2 ? '1px solid rgba(184,176,160,0.4)' : 'none',
                transition: 'all 0.2s',
              }}>
                <div style={{ flex: '0 0 auto', display: 'flex', justifyContent: align === 'right' ? 'flex-end' : 'flex-start' }}>
                  <div className="cap-icon-wrap" style={{
                    ...
                    <Icon style={{ width: 28, height: 28, color: '#B8960C', transition: 'color 0.2s' }} />
                  </div>
                </div>
                <div style={{ flex: 1 }}>
                  <div style={{
                    fontFamily: "'DM Mono', monospace", fontSize: 9,
                    letterSpacing: '0.15em', textTransform: 'uppercase',
                    color: '#9CA8BC', marginBottom: 8,
                  }}>{subtitle}</div>
                  <h3 style={{
                    fontFamily: "'Playfair Display', Georgia, serif",
                    fontSize: 26, fontWeight: 700, color: '#0C1B33', marginBottom: 14,
                  }}>{title}</h3>
                  <p style={{
                    fontFamily: "'EB Garamond', Georgia, serif",
                    fontSize: 18, lineHeight: 1.75, color: '#4A4035',
                    maxWidth: 520,
                  }}>{desc}</p>
                </div>
              </div>
      ...
      {/* ── PETITION TYPES ── soft flow section */}
      <div style={{
        background: 'linear-gradient(180deg, #F5F3EE 0%, #EDE8DF 100%)',
        padding: '80px 0 96px',
      }}>
        <div className="max-w-5xl mx-auto px-6 lg:px-10">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <div style={{
              fontFamily: "'DM Mono', monospace", fontSize: 9,
              letterSpacing: '0.22em', textTransform: 'uppercase',
              color: '#B8960C', marginBottom: 14,
            }}>Auto-Classified from Case Description</div>
            <h2 style={{
              fontFamily: "'Playfair Display', Georgia, serif",
              fontSize: 32, fontWeight: 700, color: '#0C1B33',
            }}>Supported Petition Types</h2>
          </div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 12 }}>
            {['Habeas Corpus', 'Post-Arrest Bail', 'Pre-Arrest Bail', 'Quashment of FIR', 'Property / Encroachment'].map((t, i) => (
              <div key={i} style={{
                ...
                border: '1px solid rgba(184,176,160,0.5)',
                backdropFilter: 'blur(4px)',
                transition: 'all 0.15s',
                cursor: 'default',
              }}
              onMouseOver={e => { e.currentTarget.style.background = 'white'; e.currentTarget.style.borderColor = '#B8960C'; }}
              onMouseOut={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.7)'; e.currentTarget.style.borderColor = 'rgba(184,176,160,0.5)'; }}>
                <ScrollText style={{ width: 13, height: 13, color: '#B8960C' }} />
                <span style={{ fontFamily: "'EB Garamond', Georgia, serif", fontSize: 16, color: '#0C1B33', fontWeight: 500 }}>{t}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: 72 }}>
            <p style={{
              fontFamily: "'EB Garamond', Georgia, serif",
              fontSize: 20, color: '#6B5F50', marginBottom: 28, lineHeight: 1.7,
            }}>
              Ready to bring AI to your legal practice?
            </p>
            <button onClick={() => navigate('signup')}
              style={{
                background: '#0C1B33', color: 'white',
              ...
              onMouseOver={e => e.currentTarget.style.opacity = '0.88'}
              onMouseOut={e => e.currentTarget.style.opacity = '1'}>
              Apply for Access <ChevronRight style={{ width: 14, height: 14 }} />
            </button>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: '#0C1B33' }}>
        <div style={{ height: 2, background: 'linear-gradient(90deg, #B8960C, #D4AF37, #B8960C)' }} />
        <div className="max-w-5xl mx-auto px-6 lg:px-10 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
